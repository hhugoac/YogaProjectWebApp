              ...
              <div class="collapse navbar-collapse" id="navbarsExample05">
                ...
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item cta-btn">
                    <a class="nav-link" href="member.jsp">Registrate</a>
                  </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item cta-btn">
                    <a class="nav-link" href="member.jsp">Ingresar</a>
                  </li>
                </ul>
            ...
            <div class="container">
              <div class="row slider-text align-items-center justify-content-center">
                <div class="col-md-8 text-center col-sm-12 element-animate">
                  <h1>Toma un respiro y relajate</h1>
                  ...
                  <p><a href="#" class="btn btn-white btn-outline-white">Comenzar a practicar</a> <a href="#" class="btn btn-link btn-white">Descargar</a></p>
                </div>
              </div>
            </div>
          ...
          <div class="owl-carousel centernonloop">
            <a href="#" class="item-class">
              <div class="text">
                ...
                <h2 class="class-heading">Yoga para niños</h2>
              </div>
              <img src="img/kids-yoga.jpg" alt="" class="img-fluid">
            </a>
            <a href="#" class="item-class">
              <div class="text">
                <p class="class-price">$30.99</p>
                <h2 class="class-heading">Yoga Vinyasana</h2>
              </div>
              <img src="img/ACAM1447.jpg" alt="" class="img-fluid">
            </a>
            <a href="#" class="item-class">
              <div class="text">
                <p class="class-price">$30.99</p>
                <h2 class="class-heading">Yoga Ashtanga Guiada</h2>
              </div>
              <img src="img/hot-yoga-ibiza-ashtanga.jpg" alt="" class="img-fluid">
            </a>
            <a href="#" class="item-class">
              <div class="text">
                <p class="class-price">$30.99</p>
                <h2 class="class-heading">Yoga Ashtanga</h2>
              </div>
              <img src="img/yoga4.jpg" alt="" class="img-fluid">
            </a>
          </div>
        </section> <!-- .section -->
            ...
            <div class="row no-gutters">
              <div class="col-md-6">
                <div class="sched d-block d-lg-flex">
                  ...
                  <div class="text order-1">
                    ...
                    <p class="sched-time">
                      ...
                      <span><span class="fa fa-calendar"></span> 21 Julio, 2018</span> <br>
                    </p>
                    <p><a href="#" class="btn btn-primary btn-sm">Clase a $15</a></p>
                ...
                <div class="sched d-block d-lg-flex">
                  ...
                  <div class="text">
                    <h3>Primera serie de Ashtanga</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto illo delectus...</p>
                    <p class="sched-time">
                      <span><span class="fa fa-clock-o"></span> 7:30 PM</span> <br>
                      <span><span class="fa fa-calendar"></span> 18 Julio, 2018</span> <br>
                    </p>
                    <p><a href="#" class="btn btn-primary btn-sm">Clase a $15</a></p>
              ...
              <div class="col-md-6">
                <div class="sched d-block d-lg-flex">
                  ...
                  <div class="text order-1">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto illo delectus...</p>
                    <p class="sched-time">
                      <span><span class="fa fa-clock-o"></span> 8:30 PM</span> <br>
                      <span><span class="fa fa-calendar"></span> 18 de Julio, 2018</span> <br>
                    </p>
                    <p><a href="#" class="btn btn-primary btn-sm">Clase $15</a></p>
                ...
                <div class="sched d-block d-lg-flex">
                  ...
                  <div class="text">
                    ...
                    <p class="sched-time">
                      <span><span class="fa fa-clock-o"></span> 5:30 PM</span> <br>
                      <span><span class="fa fa-calendar"></span> 17 Julio, 2018</span> <br>
                    </p>
                    <p><a href="#" class="btn btn-primary btn-sm">Clase $10</a></p>
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-12 text-center heading-wrap">
                  ...
                  <span class="back-text">Maestros</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="major-caousel js-carousel-1 owl-carousel">
                  <div>
                    <div class="media d-block media-custom text-center">
                      <a href="#"><img src="img/Emma.jpg" alt="Image Placeholder" class="img-fluid"></a>
                      <div class="media-body">
                        <h3 class="mt-0 text-black">Emma</h3>
                        <p class="lead">Maestra de Anusara Yoga</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <div class="media d-block media-custom text-center">
                      <a href="#"><img src="img/Erick.jpg" alt="Image Placeholder" class="img-fluid"></a>
                      <div class="media-body">
                        <h3 class="mt-0 text-black">Erik</h3>
                        <p class="lead">Maestro de Yoga y meditación</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <div class="media d-block media-custom text-center">
                      <a href="#"><img src="img/Elias.jpg" alt="Image Placeholder" class="img-fluid"></a>
                      <div class="media-body">
                        <h3 class="mt-0 text-black">Elias</h3>
                        <p class="lead">Maestro de Yoga flow</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div class="media d-block media-custom text-center">
                      <a href="#"><img src="img/Elias.jpg" alt="Image Placeholder" class="img-fluid"></a>
                      <div class="media-body">
                        <h3 class="mt-0 text-black">Santiago</h3>
                        <p class="lead">Maestro de Yoga flow</p>
                      </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <blockquote class="testimonial">
                  ...
                  <div class="d-flex author">
                    <img src="img/Hugo.jpg" alt="" class="mr-4">
                    <div class="author-info">
                      <h4>Hugo</h4>
                      <p>Estudiante, Generation</p>
                    </div>
                  </div>  
                </blockquote>
              </div>
              <div class="col-md-4">
                <blockquote class="testimonial">
                  <p>&ldquo; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, obcaecati? Quis eum minus, sequi atque quisquam ducimus aliquam veritatis nobis cum iusto neque enim explicabo maxime natus doloribus, fuga sunt. &rdquo;</p>
                  <div class="d-flex author">
                    <img src="img/Daniel.jpg" alt="" class="mr-4">
                    <div class="author-info">
                      <h4>Daniel Arvisu</h4>
                      <p>Estudiante, Generation</p>
                    </div>
              ...
              <div class="col-md-4">
                <blockquote class="testimonial">
                  <p>&ldquo; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, obcaecati? Quis eum minus, sequi atque quisquam ducimus aliquam veritatis nobis cum iusto neque enim explicabo maxime natus doloribus, fuga sunt. &rdquo;</p>
                  <div class="d-flex author">
                    <img src="img/Noemi.jpg" alt="" class="mr-4">
                    <div class="author-info">
                      <h4>Noemi</h4>
                      <p>Nini, no sabe que hacer de su vida aun</p>
                    </div>
                  </div>  
                </blockquote>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="blog d-block d-lg-flex">
                  <div class="bg-image" style="background-image: url('img/begginers.jpg');"></div>
                  <div class="text">
                    <h3>¿Qué es el yoga?</h3>
                    <p class="sched-time">
                      <span><span class="fa fa-calendar"></span> Abril 22, 2018</span> <br>
                    </p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto illo delectus...</p>
              ...
              <div class="col-md-6">
                <div class="blog d-block d-lg-flex">
                  <div class="bg-image" style="background-image: url('img/Starting.jpg');"></div>
                  <div class="text">
                    <h3>¿Comó comenzar?</h3>
                    <p class="sched-time">
                      <span><span class="fa fa-calendar"></span> Mayo 22, 2018</span> <br>
                    </p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto illo delectus...</p>
