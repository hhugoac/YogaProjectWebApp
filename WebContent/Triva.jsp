      ...
      <body>
                ...
                <div class="collapse navbar-collapse" id="navbarsExample05">
                  ...
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item cta-btn">
                      <a class="nav-link" href="member.html">Registrate</a>
                    </li>
                  </ul>
            ...
            <div class="container">
              <div class="row slider-text align-items-center justify-content-center">
                <div class="col-md-8 text-center col-sm-12 element-animate">
                  <h1>Unete al reto y gana un premio</h1>
        ...
        <section class="section element-animate">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6">
                    <h4 class="mb-5">Bases</h4>
                    <p class="d-flex">
                      <ul>
                          <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. </li>
                          <li> Excepturi sint facilis error voluptas, porro, alias vel incidunt </li>
                          <li> suscipit dolorem nihil soluta tempore impedit, doloribus id eveniet rerum dolore! Unde, ipsam.</li>
                      </ul>
                    </p>
              </div>
              ...
              <div class="col-lg-6 pl-2 pl-lg-5">
                <div class="col-md-8 mx-auto contact-form-contact-info">
                        <form action="TriviaServlet" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                  <div class="col-md-12 form-group">
                                    <label for="message">Acepto el reto</label>
                                    <textarea name="message" id="message" class="form-control " cols="30" rows="8"></textarea>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-6 form-group">
                                    <input type="submit" value="Acepto el reto" class="btn btn-primary">
                                  </div>
                                </div>
                              </form>
                </div>
